...
pub mod ffi {
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    fn fast_vgicp_cuda_set_transformation_epsilon(cuda_vgicp: Pin<&mut FastVGICPCuda>, eps: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    fn ndt_cuda_set_neighbor_search_method(ndt_cuda: Pin<&mut NDTCuda>, method: i32, radius: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    fn ndt_cuda_align_with_guess(ndt_cuda: Pin<&mut NDTCuda>, guess: &Transform4f) -> Transform4f {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
