...
pub mod ffi {
    ...
    unsafe impl ::cxx::ExternType for FastVGICPCuda {
        type Id = ::cxx::type_id!(FastVGICPCuda);
        type Kind = ::cxx::kind::Opaque;
    }
    unsafe impl ::cxx::private::UniquePtrTarget for FastVGICPCuda {
        fn __typename(f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.write_str(stringify!(FastVGICPCuda))
        }
        fn __null() -> ::core::mem::MaybeUninit<*mut ::core::ffi::c_void> {
            ::core::mem::MaybeUninit::new(::core::ptr::null_mut())
        }
    ...
    unsafe impl ::cxx::ExternType for NDTCuda {
        type Id = ::cxx::type_id!(NDTCuda);
        type Kind = ::cxx::kind::Opaque;
    }
    unsafe impl ::cxx::private::UniquePtrTarget for NDTCuda {
        fn __typename(f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.write_str(stringify!(NDTCuda))
        }
        fn __null() -> ::core::mem::MaybeUninit<*mut ::core::ffi::c_void> {
            ::core::mem::MaybeUninit::new(::core::ptr::null_mut())
        }
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn create_fast_vgicp_cuda() -> UniquePtr<FastVGICPCuda> {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn create_ndt_cuda() -> UniquePtr<NDTCuda> {
        unreachable!("docs-only stub")
    }
    #[allow(unused_variables, dead_code)]
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_input_source(
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_input_target(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        cloud: &PointCloudXYZ,
    ) {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_max_iterations(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        max_iterations: i32,
    ) {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_transformation_epsilon(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        eps: f64,
    ) {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_euclidean_fitness_epsilon(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        eps: f64,
    ) {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_max_correspondence_distance(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        distance: f64,
    ) {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_resolution(cuda_vgicp: Pin<&mut FastVGICPCuda>, resolution: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_set_neighbor_search_method(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        method: i32,
    ) {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_align(cuda_vgicp: Pin<&mut FastVGICPCuda>) -> Transform4f {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_align_with_guess(
        cuda_vgicp: Pin<&mut FastVGICPCuda>,
        guess: &Transform4f,
    ) -> Transform4f {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_has_converged(cuda_vgicp: &FastVGICPCuda) -> bool {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_get_fitness_score(cuda_vgicp: &FastVGICPCuda) -> f64 {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn fast_vgicp_cuda_get_final_num_iterations(cuda_vgicp: &FastVGICPCuda) -> i32 {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_input_source(ndt_cuda: Pin<&mut NDTCuda>, cloud: &PointCloudXYZ) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_input_target(ndt_cuda: Pin<&mut NDTCuda>, cloud: &PointCloudXYZ) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_max_iterations(ndt_cuda: Pin<&mut NDTCuda>, max_iterations: i32) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_transformation_epsilon(ndt_cuda: Pin<&mut NDTCuda>, eps: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_euclidean_fitness_epsilon(ndt_cuda: Pin<&mut NDTCuda>, eps: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_max_correspondence_distance(ndt_cuda: Pin<&mut NDTCuda>, distance: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_resolution(ndt_cuda: Pin<&mut NDTCuda>, resolution: f64) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_distance_mode(ndt_cuda: Pin<&mut NDTCuda>, mode: i32) {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_set_neighbor_search_method(
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_align(ndt_cuda: Pin<&mut NDTCuda>) -> Transform4f {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_align_with_guess(
        ndt_cuda: Pin<&mut NDTCuda>,
        guess: &Transform4f,
    ) -> Transform4f {
        unreachable!("docs-only stub")
    ...
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_has_converged(ndt_cuda: &NDTCuda) -> bool {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_get_fitness_score(ndt_cuda: &NDTCuda) -> f64 {
        unreachable!("docs-only stub")
    }
    #[cfg(feature = "cuda")]
    #[allow(unused_variables, dead_code)]
    pub fn ndt_cuda_get_final_num_iterations(ndt_cuda: &NDTCuda) -> i32 {
        unreachable!("docs-only stub")
    }
    #[allow(unused_variables, dead_code)]
