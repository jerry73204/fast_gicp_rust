...
use crate::{
    ...
    Error, PointCloudXYZ, RegistrationResult, Result, Transform3f,
};
use cxx::UniquePtr;
...
impl NDTCuda {
    ...
    pub fn set_input_source(&mut self, cloud: &PointCloudXYZ) -> Result<()> {
        ...
        ffi::ndt_cuda_set_input_source(self.inner.pin_mut(), cloud.as_ffi());
        Ok(())
    }
    ...
    pub fn set_input_target(&mut self, cloud: &PointCloudXYZ) -> Result<()> {
        ...
        ffi::ndt_cuda_set_input_target(self.inner.pin_mut(), cloud.as_ffi());
        Ok(())
    }
    ...
    pub fn set_max_iterations(&mut self, max_iterations: i32) -> Result<()> {
        ...
        ffi::ndt_cuda_set_max_iterations(self.inner.pin_mut(), max_iterations);
        Ok(())
    }
    ...
    pub fn set_transformation_epsilon(&mut self, epsilon: f64) -> Result<()> {
        ...
        ffi::ndt_cuda_set_transformation_epsilon(self.inner.pin_mut(), epsilon);
        Ok(())
    }
    ...
    pub fn set_euclidean_fitness_epsilon(&mut self, epsilon: f64) -> Result<()> {
        ...
        ffi::ndt_cuda_set_euclidean_fitness_epsilon(self.inner.pin_mut(), epsilon);
        Ok(())
    }
    ...
    pub fn set_max_correspondence_distance(&mut self, distance: f64) -> Result<()> {
        ...
        ffi::ndt_cuda_set_max_correspondence_distance(self.inner.pin_mut(), distance);
        Ok(())
    }
    ...
    pub fn set_resolution(&mut self, resolution: f64) -> Result<()> {
        ...
        ffi::ndt_cuda_set_resolution(self.inner.pin_mut(), resolution);
        Ok(())
    }

    /// Sets the distance calculation mode.
    pub fn set_distance_mode(&mut self, mode: NdtDistanceMode) {
        ffi::ndt_cuda_set_distance_mode(self.inner.pin_mut(), mode as i32);
    }

    /// Sets the neighbor search method.
    pub fn set_neighbor_search_method(
        &mut self,
        ...
        if radius < -1.0 {
            return Err(Error::InvalidParameter {
                message: "radius must be non-negative (-1.0 for default)".to_string(),
            });
        }
        ffi::ndt_cuda_set_neighbor_search_method(self.inner.pin_mut(), method as i32, radius);
        Ok(())
    }
    ...
    pub fn align(&mut self, initial_guess: Option<&Transform3f>) -> Result<RegistrationResult> {
        let final_transformation = if let Some(guess) = initial_guess {
            ...
            ffi::ndt_cuda_align_with_guess(self.inner.pin_mut(), &guess_ffi)
        } else {
            ffi::ndt_cuda_align(self.inner.pin_mut())
        };

        let fitness_score = ffi::ndt_cuda_get_fitness_score(&self.inner);
        let has_converged = ffi::ndt_cuda_has_converged(&self.inner);
        let num_iterations = ffi::ndt_cuda_get_final_num_iterations(&self.inner);
